        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                $totOrd=App\Model\Order::select('id','total_price')->get();
                $tdOrd=App\Model\Order::select('id')->whereDay('created_at', now()->day)->get();
                @endphp
                <h3>{{count($tdOrd)}}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                @php 
                $totalUs=App\User::select('id')->where(['role_id'=>'4'])->get();
                @endphp
                <h3>{{count($totalUs)}}</h3>
