			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Add Vender</li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->
	...
	<section class="content">
		<div class="container-fluid">
			...
			<div class="card card-default">
				...
				<!-- /.card-header -->
				<div class="card-body">
					<form method="post" action="{{route('admin.vender.insert')}}">
						@csrf
					<div class="row">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="number" name="weight" class="form-control" id="exampleInputWeight" aria-describedby="Weight">
							</div>
							<div class="form-group">
								<label for="exampleInputWeight">Emergency Contact</label>
								<div class="row">
									<div class="col-lg-12 col-md-12 col-xs-12 xol-sm-12 pl-0">
										<input type="number" class="form-control" name="e_number" id="exampleInputNumber" aria-describedby="Number">
									</div>
