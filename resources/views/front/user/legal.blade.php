			...
			<div class="row">
			  ...
			  <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 tab_wrapper">
				<div class="tab-content" id="nav-tabContent">
					...
					<div class="tab-pane fade show active" id="list-tab9" role="tabpanel" aria-labelledby="list-tab9-list">
						<div class="tab_content py-2">
							<h3 class="management_title mb-0">Legal</h3>
							<div class="bg-white">
								<div class="accordion" id="accordionExample">
									<div class="card">
										...
										<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
										  <div class="card-body">
											<h4 class="question">How do I apply a coupon code on my order?</h4>
											<p>You can apply the relevant code when you are at the cart or order summary section by clicking on " Apply Coupon" option.</p>
											<h4 class="question">How do I check the ongoing offers &amp; discount?</h4>
