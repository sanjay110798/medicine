...
@section('container')
    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" enctype="multipart/form-data" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <input type="hidden" name="purchase_key" value="{{session()->get('purchase_key')}}">
